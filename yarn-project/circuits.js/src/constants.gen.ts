...
export const EMPTY_NESTED_INDEX = 0;
export const PRIVATE_KERNEL_EMPTY_INDEX = 1;
export const PRIVATE_KERNEL_INIT_INDEX = 2;
export const PRIVATE_KERNEL_INNER_INDEX = 3;
export const PRIVATE_KERNEL_TAIL_INDEX = 4;
export const PRIVATE_KERNEL_TAIL_TO_PUBLIC_INDEX = 5;
export const PUBLIC_KERNEL_MERGE_INDEX = 6;
export const PUBLIC_KERNEL_TAIL_INDEX = 7;
export const PUBLIC_KERNEL_INNER_INDEX = 8;
export const BASE_PARITY_INDEX = 10;
export const ROOT_PARITY_INDEX = 11;
export const BASE_ROLLUP_INDEX = 12;
export const MERGE_ROLLUP_INDEX = 13;
export const BLOCK_ROOT_ROLLUP_INDEX = 14;
export const BLOCK_MERGE_ROLLUP_INDEX = 15;
export const ROOT_ROLLUP_INDEX = 16;
export const BLOCK_ROOT_ROLLUP_EMPTY_INDEX = 17;
export const TUBE_INDEX = 18;
...
export const PUBLIC_CALL_REQUEST_LENGTH = 6;
...
export const PRIVATE_ACCUMULATED_DATA_LENGTH = 1064;
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1888;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1055;
export const NUM_PUBLIC_ACCUMULATED_DATA_ARRAYS = 8;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2997;
export const VM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2374;
...
export const AVM_PROOF_LENGTH_IN_FIELDS = 4047;
...
export const FUNCTION_SELECTOR_KERNEL_INPUTS_COL_OFFSET = 2;
